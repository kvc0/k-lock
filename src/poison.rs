...
///
/// [`Mutex`]es are poisoned whenever a thread fails while the lock
/// is held. Once a lock is poisoned then all future acquisitions will
/// return this error.
///
/// # Examples
///
